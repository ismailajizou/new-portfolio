    ...
    <Section id="testemonials">
      ...
      {testimonials.length ? (
        <div className="relative mb-8">
          ...
          <div className="dark:from-background pointer-events-none absolute inset-y-0 left-0 hidden w-1/3 bg-gradient-to-r from-white md:block" />
          <div className="dark:from-background pointer-events-none absolute inset-y-0 right-0 hidden w-1/3 bg-gradient-to-l from-white md:block" />
        </div>
      ) : (
